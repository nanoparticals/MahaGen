...
def write_poscar(mol, filename, box_size=20.0):
    """
...
# 1. 读取 CSV 文件
input_csv = '/public/home/users/haoxw/generate_AI/branch_Li/ckpts/gpu_rl_vgae_soft_congen_15/outputs/all_molecules_dedup.csv' # 确保文件名与你的CSV一致
output_dir = '/public/home/users/haoxw/generate_AI/branch_Li/DFT/poscar_files'
...
if not os.path.exists(input_csv):
    ...
    for i, smiles in enumerate(top_molecules):
        ...
        if mol:
            ...
            write_poscar(mol, filename, box_size=20.0)
        else:
...
# ================= 配置区域 =================
# 根目录
BASE_DIR = "/public/home/users/haoxw/generate_AI/branch_Li/DFT"
# POSCAR 所在的文件夹 (上一步生成的)
POSCAR_SOURCE_DIR = os.path.join(BASE_DIR, "poscar_files")
# 计算工作目录 (将要创建的)
CALC_DIR = os.path.join(BASE_DIR, "dft_calculate")
