...
def main():
    ...
    ap.add_argument("--max-gen", type=int, default=303, help="生成集最大抽样数")
    ...
    ap.add_argument("--out", default="figure_b_chemspace.png", help="输出图片文件")
    args = ap.parse_args()
    ...
    plt.scatter(Y_ge[:, 0], Y_ge[:, 1], s=14, alpha=0.1, label="Generated", color="#ff7f0e", edgecolors="none")
